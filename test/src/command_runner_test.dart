...
import 'package:eway/src/command_runner.dart';
...
void main() {
  group('EwayCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late EwayCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = EwayCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = EwayCommandRunner();
